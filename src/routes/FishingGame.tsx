...
export default function FishingGame() {
  ...
  useEffect(() => {
    get(ref(db, "users/" + uid + "/classes/" + className))
      .then((teacherUID) => {
        get(
          ref(
            db,
          ...
          function populateObjects(fish1, fish2, fish3, fish4) {
            if (questionList[0]) {
              ...
              let answerList = shuffleArray(
                Object.keys(questions[questionList[0]])
              );
          ...
          function generateModal(
            header: SetStateAction<string>,
            body: SetStateAction<string>
          ) {
          ...
          function fishLoop() {
            ...
            fish1.x =
              fish1.x + fishVelocity1 > canvas.width
                ? 0 - width
                : fish1.x + fishVelocity1;
            fish2.x =
              fish2.x + fishVelocity2 > canvas.width
                ? 0 - width
                : fish2.x + fishVelocity2;
            fish3.x =
              fish3.x - fishVelocity3 < 0 - width
                ? canvas.width
                : fish3.x - fishVelocity3;
            fish4.x =
              fish4.x - fishVelocity1 < 0 - width
                ? canvas.width
                : fish4.x - fishVelocity1;
            //display fish1:
            ...
            if (mouseClicked) {
              ...
              if (
                ...
                if (fish1.correctAnswer == true) {
                  ...
                  generateModal(
                    "Uh Oh",
                    "Looks like that was wrong, try again!"
                  );
                rodEndY = 10;
                mouseClicked = false;
                populateObjects(fish1, fish2, fish3, fish4);
  ...
  useEffect(() => {
    ...
    } else if (!showGameOverModal) window.location.href = "/student";
  }, [showGameOverModal]);
  ...
  return (
    <div>
      ...
      <ModalPopup
        ...
        toggleModal={() => {
          toggleGameOverModal(!showGameOverModal);
        }}
        header={"Game Over!"}
        body={
          <div>
            <p>Great Job, You Have Finished the Quiz!</p>
          </div>
        }
        footer={
          <div>
